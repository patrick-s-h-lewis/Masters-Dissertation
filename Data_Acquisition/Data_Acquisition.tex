...
\begin{figure}[H]
    ...
    \caption{Articles grouped by publisher in the Large Scale Scrape doi database (marked 'Large Scale Scrape Dois' in figure \ref{fig:DATABASES}). Only the top 12 publishers are shown.}
     \label{fig:PUBPI}
\end{figure}
